defmodule TailscaleTransport.MixProject do
  ...
  defp description do
    """
    A transport for ThousandIsland that allows exposing services directly to your Tailscale network.
    """
  end
  ...
  def links do
    %{
      ...
      "Readme" => "https://github.com/Munksgaard/tailscale_transport/blob/v#{@version}/README.md",
      "Changelog" =>
        "https://github.com/Munksgaard/tailscale_transport/blob/v#{@version}/CHANGELOG.md"
    }
  end
